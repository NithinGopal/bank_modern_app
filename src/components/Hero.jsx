...
import { heroDiscountVariants, textVariants, heroImgVariants } from '../framerVariants'
  ...
  return (
    ...
    >
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <motion.div 
          variants={heroDiscountVariants} whileHover='hover'
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative `}>
        <motion.img src={robot} alt="billing" 
          variants={heroImgVariants} initial='hidden' animate='visible'
